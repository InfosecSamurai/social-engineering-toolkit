...
## Contents
- `usb_payload.sh`: Basic USB attack simulation (safe for labs)
- `usb_attack_simulation_edr_demo.sh`: EDR/XDR detection testing script
- `cleanup.sh`: Artifact removal tool (if needed)
...
### Attack Simulation:
- **Initial Access**: USB auto-execution simulation
- **Persistence**: User-level systemd service creation
- **Exfiltration**: Simulated data collection and C2 callbacks
